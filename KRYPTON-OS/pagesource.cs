...
namespace krypto_os
{
    public partial class pagesource : Form
    {
        ...
        public void loadPageSource(string pageSourceTxt)
        {
            sourceBox.Text = pageSourceTxt;
        }

        public static void launch_pagesource(string clienttxt)
        {
            pagesource x = new pagesource();
            x.loadPageSource(clienttxt);
            x.ShowDialog();
            x.loadPageSource(clienttxt);
        }
